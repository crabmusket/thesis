...
\begin{figure}
   ...
   \begin{adjustwidth}{-2cm}{-2cm}
   \begin{subfigure}[b]{0.65\textwidth}
      \includegraphics[width=\textwidth]{results/mpc-rho-1.1}
      \caption{With $\rho = 1e-9$}
      \label{fig:mpc-rho-1.1}
   \end{subfigure}
   ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc.
   \begin{subfigure}[b]{0.65\textwidth}
      \includegraphics[width=\textwidth]{results/mpc-rho-3.5}
      \caption{With $\rho = 5e-7$}
      \label{fig:mpc-rho-3.5}
   \end{subfigure}
   \end{adjustwidth}
