...
\Autoref{sec:models:control} outlines the linear state-space model for MPC, and then describes the simplifying assumptions made to express the nonlinear simulation model as a linear model.
...
One further nonlinearity exists in \autoref{eq:Q-mflow}, where the min and max functions are used to express conditionality.
