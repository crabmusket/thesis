...
\todo{Mention~\cite{Greening14} and~\cite{Chandrasekar04}.}
...
\end{equation}
\todo{fix optimisation problem rendering}
...
Note that if a system is linear and its objective function convex, the optimisation problem governing its control can be convex, and hence efficiently solved.
...
\todo{Mention \textcite{Vukov12} and \textcite{Houska11}}
