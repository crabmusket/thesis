...
\todo{Diagram of house/hot water system}
...
\begin{description}
   ...
   \item[Scale] Solar hot water services must obviously come in many sizes to fulfil the requirements of different users.
      The variables include the size of the water tank itself, the area of and water volume in the solar collectors, the power of the auxiliary booster, 
\end{description}
...
\todo{Diagram of convex function}
...
\opinion{It has yet to be seen whether the same gains discovered by \textcite{Wang10} in the area of MPC can be achieved by this general software.}
\todo{Refer to MPC chapter in lit review}

\section{Nonconvex optimisation}

\todo{Introduce ACADO, \textcite{Houska11}.
Mention code generation.
Refer to MPC chapter in lit review.}
