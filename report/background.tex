...
\begin{description}
	...
	\item[\todo{thingy}] Some systems include a \todo{thingy} that allows water from the collector output to bypass the storage tank and be returned to the collector input for further heating.
\end{description}
